...
export type GetHotelDetailQuery = { hotel: { id: string, name: string, location: string, carbonAwards: Array<string>, fullereneAwards: Array<string>, carbonNanotubeAwards: Array<string>, grapheneAwards: Array<string>, diamondAwards: Array<string> } };
...
export type EditHotelMutation = { editHotel: { id: string, name: string, location: string, carbonAwards: Array<string>, fullereneAwards: Array<string>, carbonNanotubeAwards: Array<string>, grapheneAwards: Array<string>, diamondAwards: Array<string> } };
...
export type FindHotelsQuery = { hotels: Array<{ id: string, name: string, location: string }> };
...
export type AddHotelMutation = { addHotel: { id: string, name: string, location: string, carbonAwards: Array<string>, fullereneAwards: Array<string>, carbonNanotubeAwards: Array<string>, grapheneAwards: Array<string>, diamondAwards: Array<string> } };

export type FindMyStaysQueryVariables = Exact<{ [key: string]: never; }>;


export type FindMyStaysQuery = { stays: Array<{ id: string, checkinTime: any, hotel: { name: string } }> };
